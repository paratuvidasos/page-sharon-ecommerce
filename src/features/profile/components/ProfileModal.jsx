...
// También aloja la entrada a AddressBookModal (direcciones de envío guardadas),
// anidado como hermano del Modal principal (mismo patrón que el diálogo de Google
// dentro de AuthModal) para que su propio overlay/panel no queden atrapados por el
// `transform` del panel de este Modal.
export const ProfileModal = ({ open, onClose, user, onSave, addresses, setAddresses }) => {
